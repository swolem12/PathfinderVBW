...
T+5m   Functions/AIP caches invalidate on next read`,
  ...
  /* ================================================================ */
  /* LESSON 9 — AIP ASSIST · PROJECT-FOLDER BOT                       */
  /* ================================================================ */
  {
    id: 'aip-assist-project-bot',
    number: 9,
    title: 'AIP Assist · train a bot on a project folder',
    subtitle:
      'Point AIP Assist at a Compass folder, tune its indexing, and ship a team-scoped copilot your users can chat with.',
    goal:
      'You can create an AIP Assist bot scoped to a single project folder, curate what gets indexed, tune retrieval and prompting, test with an eval set, publish it to a Workshop/Slate sidebar, and monitor drift + feedback after launch.',
    endState:
      "A FleetOps Assist bot lives in the FleetOps project folder, indexes every Slate doc, Notepad, Notebook, and Ontology-linked dataset dictionary in that folder, answers operator questions with inline citations back to source, and has a feedback loop that flags low-confidence answers for weekly review.",
    estMinutes: 18,
    blocks: [
      /* -------- WHAT + WHY -------- */
      ...
      },
      {
        ...
        term: 'Eval set',
        plain:
          "A fixed list of questions with known-good answers (or known-good citations). Re-run this every time you change the bot's prompt or scope to catch regressions before users do.",
      },
      ...
      /* -------- STEP-BY-STEP BUILD -------- */
      { type: 'h', body: 'Step-by-step: ship a folder-scoped bot' },
      {
        type: 'step',
        n: 1,
        title: 'Curate the folder first',
        body:
          "Open the project folder in Compass. Move stale docs to an /archive subfolder (or a sibling folder outside the bot's scope). Pin a /_bot-sources subfolder for anything authored specifically for the bot (glossaries, SOP rewrites). Rule of thumb: if you would not onboard a new hire with this doc, do not feed it to the bot.",
      },
      {
        type: 'step',
        n: 2,
      ...
      },
      {
        ...
        body:
          "Cover: happy path, paraphrased happy path, adjacent-but-wrong (bot should refuse), ambiguous (bot should ask a clarifier), permission-sensitive (admin Q run as technician should fail). Save the eval set in /_bot-sources so the team can review.",
      },
      {
        type: 'step',
        n: 7,
      ...
      },
      {
        ...
        body:
          "Publish v1. Copy the bot's embed snippet. Drop it into the FleetOps Slate doc as an AIP Assist widget in the right-hand rail. Announce in the team channel with 3 example questions and a 'click the thumbs down' ask.",
      },
...
helping a new hire, not like a customer-service chatbot.`,
      ...
      /* -------- TRAINING THE BOT: SOURCE HYGIENE -------- */
      { type: 'h', body: "Training is mostly writing docs the right way" },
      {
        type: 'p',
        body:
      ...
      {
        type: 'details',
        summary: 'Worked example \u2014 rewriting a doc for retrievability',
        blocks: [
          {
            type: 'code',
            block: {
      ...
      /* -------- EVAL SET -------- */
      { type: 'h', body: 'Build your eval set \u2014 the one artifact that compounds' },
      {
        type: 'code',
        block: {
          kind: 'code',
      ...
      /* -------- TUNING RETRIEVAL -------- */
      { type: 'h', body: 'Tuning retrieval when the bot is wrong' },
      {
        type: 'visualRef',
        title: 'Diagnose from the Retrieved Chunks panel',
        columns: 2,
        items: [
      ...
      /* -------- GOVERNANCE + SAFETY -------- */
      { type: 'h', body: 'Governance, safety, and permission boundary' },
      {
        type: 'list',
        items: [
